...
<div class="shelters">
    <div class="page__title">
        Регіональні мапи укриттів
    </div>
    <div class="accordion">
        <div class="accordion__item" data-collapse="#kyiv">
            <div class="accordion__header">
                <div class="accordion__title">Київ</div>
            </div>
        ...
        <div class="accordion__item" data-collapse="#kharkiv_obl">
            <div class="accordion__header">
                <div class="accordion__title">Харківщина</div>
            </div>
        ...
        <div class="accordion__item" data-collapse="#sumy">
            <div class="accordion__header">
                <div class="accordion__title">Суми</div>
            </div>
        ...
        <div class="accordion__item" data-collapse="#odesa">
            <div class="accordion__header">
                <div class="accordion__title">Одеса</div>
            </div>
        ...
        <div class="accordion__item" data-collapse="#dnipro">
            <div class="accordion__header">
                <div class="accordion__title">Дніпро</div>
            </div>
        ...
        <div class="accordion__item" data-collapse="#kryvyi_rih">
            <div class="accordion__header">
                <div class="accordion__title">Кривий Ріг</div>
            </div>
        ...
        <div class="accordion__item" data-collapse="#poltava">
            <div class="accordion__header">
                <div class="accordion__title">Полтава</div>
            </div>
